...
Fixed rubric for tiering Job Radar roles. The deterministic gates (track, freshness, location, comp floor) already ran in code before a role reaches this rubric. This rubric only decides A vs B among survivors.
